...
int main()
{
    ...
    auto result = bankomat.Vydat_dengi(cash);
    int b5000, b2000, b1000, b500, b200, b100;
    bankomat.Deconstruct(b5000, b2000, b1000, b500, b200, b100);
    cout << "Выдано: по 5000 руб: " << result.dengi5000 << "шт.\n";
    cout << "Выдано: по 2000 руб: " << result.dengi2000 << "шт.\n";
    cout << "Выдано: по 1000 руб: " << result.po_tysyache << "шт.\n";
    cout << "Выдано: по 500 руб: " << result.patsot << "шт.\n";
    cout << "Выдано: по 200 руб: " << result.dvesti << "шт.\n";
    cout << "Выдано: по 100 руб: " << result.sto << "шт.\n";
    cout << "--------\n";
